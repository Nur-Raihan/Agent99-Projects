...
if($color_pic['name'] != '' && $color_pic['size'] != 0) {
    ...
    $color_pic = $_POST['old_image'];
}


$conn = mysqli_connect('localhost', 'root', '','gms');
$sql = "UPDATE color SET color_pic='$color_pic' WHERE color_id = $color_id";

if(mysqli_query($conn, $sql)){
        $_SESSION['message'] = "";
        header("Location: color_single_view.php?color_id=" . $color_id);
} else{
