...
//------------------------------------
 ...
 $sql = "SELECT deying.deying_id, deying.date, deying.order_id, deying.target, deying.type, deying.complete, deying.uncomplete, deying.comment, export_order.quantity, export_order.p_name FROM deying INNER JOIN export_order on deying.order_id = export_order.order_id order by deying_id desc";
...
<!--************************************************* Main Form Start ************************************************* -->
    <div class="col-sm-10"><!-- Form Size (For Dashboard, Details, Form etc)-->
        ...
        <div class="list-group-item active" style="background-color:#3498DB; color:#ffffff;border-color:#3498DB">
         <a href="deying_form.php" class="btn btn" style="background-color: white">Go to form</a>
         <a href="panel.php" class="btn btn" style="background-color: white">Back to homepage</a> Garment Dyeing List
        </div><br>                           
    ...
    <?php 
      ...
      <tr>
        ...
        <td class="buttonsBlock">  
               <a class="btn" style="background-color: #58d68d"  href="deying_single_view.php ?deying_id=<?php echo $row['deying_id']; ?> ">View </a>

               <a class="btn" style="background-color: #5dade2" href="deying_edit.php ?deying_id=<?php echo $row['deying_id']; ?> ">Edit </a>

               <a class="btn" style="background-color: #FA8072"  href="deying_delete.php ?deying_id=<?php echo $row['deying_id']; ?> ">Delete </a>
        </td>
