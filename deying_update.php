...
$sql = "UPDATE deying SET date='$date', order_id='$order_id', target='$target', type='$type', complete='$complete', uncomplete='$uncomplete', comment='$comment' WHERE deying_id = $deying_id";

if(mysqli_query($conn, $sql)){
        $_SESSION['message'] = "";
	    header("Location: deying_edit.php?deying_id=" . $deying_id);
} else{
