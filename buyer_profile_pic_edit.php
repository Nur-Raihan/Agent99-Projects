...
<!--************************************************ Navigation bar End ************************************************ -->
    ...
    <div class="container">
        ...
        <form class="well form-horizontal" action="buyer_profile_pic_update.php?buyer_id=<?php echo $buyer_id ?>" enctype="multipart/form-data" method="post"> <!-- form class well form horizontal will protect form from being collaps and make all straigt in horizontal-->
            <fieldset> <!-- Create a border along with all input -->

             <!-- Text input-->
               <h3 style="color: #5D6D7E"><center>Profile Image Update</center></h3><br><br>

               <div class="form-group"> <!-- div form-group place the div in middle -->
                 <label class="col-md-3 control-label">Buyer Image</label> <!--without control-label text will go to the left side-->
                 <div class="col-md-6"> <!-- controll the input space size -->
                     <div class="input-group"> <!--This div input-group let the upper div stay side by side  -->
                         ...
                         <input type="file" id="fileUpload" name="buyer_pic" class="form-control" required>
                     </div>
