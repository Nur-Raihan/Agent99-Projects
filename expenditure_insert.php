...
$sql = "INSERT INTO expenditure VALUES (NULL, '$date', '$gas', '$electricity','$water','$electrical_applience','$food','$medic','$newspaper','$stationary','$telephone','$total');";

if(mysqli_query($conn, $sql)){
        $_SESSION['message'] = "";
        header("Location: expenditure_form.php");
} else{
