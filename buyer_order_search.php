...
<div class="col-md-10">
        ...
        <a href="buyer_panel.php" class="btn btn" style="background-color: white">Go to homepage</a>
  ...
  <div style="overflow-x:auto;">
	<table class="table table-hover" style="background-color:#ecf0f1">
	  ...
	  <?php 
            ...
            $show = "SELECT * FROM export_order WHERE buyer_id =$current_customer where order_id Like '%$get%' OR buyer_id Like '%$get%' OR p_name Like '%$get%' ";
            if($show){
      ...
      <td> <?php echo $row['delivery_date']?>  </td>
        ...
        <td class="buttonsBlock">   
               <a class="btn" style="background-color: #58d68d"  href="buyer_order_single_view.php ?order_id=<?php echo $row['order_id']; ?> ">View </a>
