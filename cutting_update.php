...
$sql = "UPDATE cutting SET date='$date', order_id='$order_id', target='$target', complete='$complete', uncomplete='$uncomplete', comment='$comment' WHERE cutting_id = $cutting_id";

if(mysqli_query($conn, $sql)){
        $_SESSION['message'] = "";
	    header("Location: cutting_edit.php?cutting_id=" . $cutting_id);
} else{
