...
$found_order = "SELECT * FROM cutting WHERE order_id = '$order_id'";
...
$sql = "INSERT INTO cutting VALUES (NULL, '$date', '$order_id', '$target', '$complete', '$uncomplete', '$comment');";


 if(mysqli_query($conn, $sql)){
        $_SESSION['message'] = "";
        header("Location: cutting_form.php");
} else{
