...
<!--************************************************ Navigation bar End ************************************************ -->
    ...
    <div class="container">
        ...
        <a href="cutting_details.php" class="btn" style="background-color: white">Go to List</a>
        <a href="panel.php" class="btn" style="background-color: white">Panel</a>
        </div>

              
        <form class="well form-horizontal" action="cutting_insert.php" method="post"> <!-- form class well form horizontal will protect form from being collaps and make all straigt in horizontal-->
            <fieldset> <!-- Create a border along with all input -->

                <!-- Form Name -->
             <div class="list-group-item active" align="center">Garment Sewing Details</div>
            <br><br>
             <!-- Text input-->
